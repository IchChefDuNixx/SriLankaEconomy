...
try:
    ...
    financial_crisis_fig = px.scatter_map(
        financial_crisis_df,
        lat="Latitude",
        lon="Longitude",
        hover_name="State",
...
try:
    ...
    refugee_crisis_fig = px.scatter_map(
        refugee_crisis_df,
        lat="Latitude",
        lon="Longitude",
        hover_name="State",
...
try:
    ...
    easter_attacks_fig = px.scatter_map(
        easter_attacks_df,
        lat="Latitude",
        lon="Longitude",
        hover_name="Location",
